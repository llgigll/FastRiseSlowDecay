function [rise_time, decay_time] = dfdbk_std_manysynapses_changep_RandD(w,k,q,qdiff,tr,U,I_step,w_in,q_in,stim_setup)
...
function dy = odefun(t,y)
    ...
    input(3) = (1/N)*y(1)*dot((1-q-qdiff),y_std(1:2));  %AMPA
    input(4) = (1/N)*y(1)*dot((q+qdiff),y_std(1:2));     %NMDA
    % Excitatory to Inhibitory
    input(5) = (1/N)*y(1)*dot((1-q),y_std(3:4));   %AMPA
    input(6) = (1/N)*y(1)*dot(q,y_std(3:4));       %NMDA
