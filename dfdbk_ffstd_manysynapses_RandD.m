function [rise_time, decay_time] = dfdbk_ffstd_manysynapses_RandD(w,k,q,qdiff,tr,U,tr_ff,U_ff,I_step,w_in,q_in,stim_setup)
...
tspan = [t0 t_end];
options = odeset('MaxStep',0.001,'nonnegative',1:13,'events',events);
