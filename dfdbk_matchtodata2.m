% Setup for monkey 2 adding offset latency
...
holder = origpop.AmbigEdge2.analysis.difference.allcellsrates(:,:,66:end);
...
for i = 9:9
    ...
    figure('color','w')
    plot((301:2:2001)/1000-0.561,Pe_rate(151:1001))
    hold on
    xlim(([561,2001]/1000-0.561))
end
hold on
