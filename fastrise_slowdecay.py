...
#       Set up parameters (Different time const for ti)
#    exp_struct['trec_base'] = 500.0 * bn.ms
#    exp_struct['u_base'] = 0.20
#    
#    exp_struct['delta_q'] = 0.25
...
#    exp_struct['baseline_mult'] = 1.75
    
    
#==============================================================================
#     Parameters for figure 2, dfdbk as a function of STD
#==============================================================================
    exp_struct['trec_base'] = 500.0 * bn.ms
    
    exp_struct['delta_q'] = 0.1
    exp_struct['delta_u'] = 0.0
    exp_struct['delta_tr'] = 0.00 * bn.ms
...
#==============================================================================
#     Parameters for figure 7, dfdbk as a function of delta q
##==============================================================================
#    exp_struct['trec_base'] = 500.0 * bn.ms
#    
#    
...
#    exp_struct['baseline_mult'] = 0.65
#    
#    exp_struct['u_base'] = 0.1
##    exp_struct['Jin'] = 0.45
#    exp_struct['Jin'] = 0.6
#    
#    
#    delta_q_hold = [0.1,0.2]
##    delta_q_hold = [0.0]
#    file_base = 'dfdbk_final2_deltaq'
#    for i in range(len(delta_q_hold)):
#        local_delta_q = delta_q_hold[i]
#        exp_struct['delta_q'] = local_delta_q
#        save_file = file_base+str(int(100*local_delta_q))
#        print 'delta_q='+str(local_delta_q)+'\n Save File: '+save_file
#        hold = rep_supp(exp_struct, net_struct,new_connectivity,save_file)   
#        
#        Pe_rate = hold['Pe_rate']
#        T = hold['Pe_times']
...
#==============================================================================
#     Parameters for figure 7, dfdbk as a function of delta q with ffd std
#==============================================================================
#    exp_struct['trec_base'] = 500.0 * bn.ms
#    
#    
...
#    exp_struct['delta_q'] = 0.1
#    
#    uff_hold = [0.1,0.25,0.5]
#    file_base = 'dfdbk_final2_ffdstd_uff_'
#    for i in range(len(uff_hold)):
#        local_uff = uff_hold[i]
#        exp_struct['uff'] = local_uff
#        exp_struct['Jin'] = 0.6*(1+0.5*20*local_uff)
##        exp_struct['Jin'] = 0.45*(1+0.5*20*local_uff)
#        save_file = file_base+str(int(100*local_uff))
#        print 'uff='+str(local_uff)+'\n Save File: '+save_file
#        hold = rep_supp(exp_struct, net_struct,new_connectivity,save_file)   
#        
#        Pe_rate = hold['Pe_rate']
#        T = hold['Pe_times']
...
#==============================================================================
#     Parameters for figure 7, dfdbk as a function of delta u
#==============================================================================
#    exp_struct['trec_base'] = 500.0 * bn.ms
#    exp_struct['u_base'] = 0.1
#    exp_struct['delta_q'] = -0.011
#    
#    exp_struct['uff'] = 0.0
#    exp_struct['trecff'] = 500.0*bn.ms
#    
...
#    exp_struct['k'] = 1.0
#    exp_struct['neuron_mult'] = net_struct
#    exp_struct['baseline_mult'] = 0.375
#    
#
##    exp_struct['Jin'] = 0.45
##    exp_struct['Jin'] = 0.25
...
##    p_hold = [0.25]
##    p_hold = [0.0,0.125]
##    delta_q_hold = [-0.0065,-0.0085] # -0.011
#    p_hold = [0.125]
#    delta_q_hold = [-0.0085] # -0.011
#    file_base = 'dfdbk_final2_p_'
#    for i in range(len(p_hold)):
#        local_p = p_hold[i]
#        local_delta_q = delta_q_hold[i]
#        local_delta_u  = local_p * exp_struct['u_base']
#        local_delta_tr = local_p * exp_struct['trec_base']
#        exp_struct['delta_u'] = local_delta_u
#        exp_struct['delta_tr'] = local_delta_tr
#        exp_struct['delta_q'] = local_delta_q
#
#        save_file = file_base+str(int(100*local_p))
#        print 'uff='+str(local_p)+'\n Save File: '+save_file
#        hold = rep_supp(exp_struct, net_struct,new_connectivity,save_file)   
#        
#        Pe_rate = hold['Pe_rate']
#        T = hold['Pe_times']
...
#        plt.savefig(save_file+'.png')
  ...
  #==============================================================================
#     Parameters for figure 7, dfdbk as a function of delta u with ffd std
#==============================================================================
#    exp_struct['trec_base'] = 500.0 * bn.ms
#    exp_struct['u_base'] = 0.1
#    exp_struct['delta_q'] = -0.003
#    
#    exp_struct['uff'] = 0.2
#    exp_struct['trecff'] = 500.0*bn.ms
#    
...
##    exp_struct['Jin'] = 0.45
##    exp_struct['Jin'] = 0.25
#    exp_struct['Jin'] = 0.55*(1+0.5*20*0.2)
#    
#    
##    p_hold = [0.25]
#    p_hold = [0.25,0.125,0.0]
#    file_base = 'dfdbk_final2_ffdstd_p_'
#    for i in range(len(p_hold)):
#        local_p = p_hold[i]
#        local_delta_u  = local_p * exp_struct['u_base']
#        local_delta_tr = local_p * exp_struct['trec_base']
...
#    
#    p = 0.125
#    exp_struct['delta_u']  = p * exp_struct['u_base']
#    exp_struct['delta_tr'] = p * exp_struct['trec_base']
#    
#    exp_struct['uff'] = 0.2
#    exp_struct['trecff'] = 500.0*bn.ms
#    
...
#       
#    uff_hold = [0.1,0.25,0.5]
#    file_base = 'dfdbk_final_ffdstd_p0125_uff'
#    for i in range(len(uff_hold)):
#        
#        local_uff = uff_hold[i]
#        exp_struct['uff'] = local_uff
#        exp_struct['Jin'] = 0.55*(1+0.5*20*local_uff)
#        save_file = file_base+str(int(100*local_uff))
#        
#        print 'uff='+str(local_uff)+'\n Save File: '+save_file
#        hold = rep_supp(exp_struct, net_struct,new_connectivity,save_file)   
