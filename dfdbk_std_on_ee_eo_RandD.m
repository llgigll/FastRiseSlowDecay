function [rise_time,decay_time] = dfdbk_std_on_ee_eo_RandD(w,k,q,diff,tr_e,U_e,tr_ff,U_ff,I_step,w_in,q_in)
% Compute the rise and decay time of the derivative feedback network with
% STD on the excitatory connections and the input connections.
